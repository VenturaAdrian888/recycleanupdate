...
public class Buyer_Profile extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navTool =  findViewById(R.id.buyerToolbar_Prof);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.home:
                        Intent home = new Intent(Buyer_Profile.this, Buyer_Interface.class);
                        startActivity(home);
                        break;

                    case R.id.AboutUs:
                        Intent about = new Intent(Buyer_Profile.this, AboutUs.class);
                        startActivity(about);
                        break;
