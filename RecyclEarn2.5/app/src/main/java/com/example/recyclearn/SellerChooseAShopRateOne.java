...
public class SellerChooseAShopRateOne extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seller_choose_ashop_rate_one);
            ...
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                documentReference2.addSnapshotListener(new EventListener<DocumentSnapshot>() {
                    ...
                    public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                        ...
                        DocumentReference documentReference3 = fStore.collection("Buyer_Users").document(shopuid);
...
// navigation menu items declaration
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuitem) {
        ...
        switch (menuitem.getItemId()) {
            case R.id.nav_sellerhome:
                Intent intent = new Intent(SellerChooseAShopRateOne.this, SellerDashboard.class);
                startActivity(intent);
                break;
            case R.id.nav_sellerprofile:
                Intent intent1 = new Intent(SellerChooseAShopRateOne.this, SellerProfile.class);
                startActivity(intent1);
                break;
            case R.id.nav_sellerlocation:
                Intent intent2 = new Intent(SellerChooseAShopRateOne.this, SellerLocation.class);
                startActivity(intent2);
                break;
            case R.id.nav_sellerSecurity:
                Intent security = new Intent(SellerChooseAShopRateOne.this, Seller_Security.class);
                startActivity(security);
                break;
            case R.id.nav_sellerinfo:
                Intent intent3 = new Intent(SellerChooseAShopRateOne.this, SellerAboutUs.class);
    ...
    public void opensellerprofile() {
        Intent intent = new Intent(SellerChooseAShopRateOne.this, SellerProfile.class);
        startActivity(intent);
    }
}