...
public class Buyer_ChangeEmail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buyer_change_email);
        ...
        changeEmailAddress.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Buyer_ChangeEmail.this, "Email Changed!", Toast.LENGTH_SHORT).show();
                ...
                reference.child(FirebaseAuth.getInstance().getCurrentUser().getUid().toString()).updateChildren(hashMap).addOnSuccessListener(new OnSuccessListener() {
                    ...
                    public void onSuccess(Object o) {
                        Toast.makeText(Buyer_ChangeEmail.this,"Updated",Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
