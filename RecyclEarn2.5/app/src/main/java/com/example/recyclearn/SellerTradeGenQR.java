...
//display profile picture
        ...
        viewPointsPerKG = findViewById(R.id.pointsPerKG);

        viewPointsPerKG.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent pointsperKG = new Intent(SellerTradeGenQR.this, EquivalentPointsPerKG.class);
                startActivity(pointsperKG);
            }
        });
//QR input
    ...
    public boolean goToGen() {
        ...
        if (Double.parseDouble(kgInput1.getText().toString().trim()) > 5) {
    ...
    public void permision() {
        ...
        if (isAllFieldsChecked) {
            ...
            Toast.makeText(SellerTradeGenQR.this,"Updated",Toast.LENGTH_SHORT).show();
        }
    }
