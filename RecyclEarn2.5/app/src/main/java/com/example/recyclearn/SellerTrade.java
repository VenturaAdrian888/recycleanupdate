...
public class SellerTrade extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private TextView sellerrequiredbottles1;
...
//drawer
        ...
        contentView = findViewById(R.id.tradeContent);
...
//display profile picture
        ...
        sellerrequiredbottles1 = findViewById(R.id.bottles);
        sellerrequiredbottles1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                gotreq();
            }
...
// navigation menu items declaration
    ...
    public void onBackPressed() {
        if (drawerLayout.isDrawerOpen(GravityCompat.START)) {
            ...
            Intent balik = new Intent(SellerTrade.this, SellerDashboard.class);
        startActivity(balik);
        super.onBackPressed();
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuitem) {
        ...
        switch (menuitem.getItemId()) {
            ...
            case R.id.nav_sellerSecurity:
                Intent security = new Intent(SellerTrade.this, Seller_Security.class);
                startActivity(security);
                break;
            case R.id.nav_sellerinfo:
                Intent intent3 = new Intent(SellerTrade.this, SellerAboutUs.class);
    ...
    public void  BtnContinue() {
        Intent continuebtn = new Intent(SellerTrade.this, SellerChooseAShop.class);
        startActivity(continuebtn);
    }
    public void gotreq(){
        Intent qrbt = new Intent(SellerTrade.this, SellerBottleReq.class);
        startActivity(qrbt);
    }
}