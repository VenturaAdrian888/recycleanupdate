...
//Display user info in drawer
        ...
        documentReference.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                String shopuid = value.getString("shopowner1"); // Buyer 1 UID

                navHeadername = navigationView.getHeaderView(0).findViewById(R.id.nav_usernameseller);
                navHeadername.setText(username);

                //buyer display name
                final TextView UsernameShop = (TextView) findViewById(R.id.ShopOwnerName1);
                DocumentReference documentReference2 = fStore.collection("Buyer_Users").document(shopuid);
                ...
                StorageReference profileRef1 = storageReference.child("user_buyer/"+ shopuid +"/profile.jpg");
...
// navigation menu items declaration
    ...
    public void rateone() {
        Intent intent = new Intent(SellerChooseAShop.this, SellerChooseAShopRateOne.class);
        startActivity(intent);
    }
}