...
public class Buyerddddddddd extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buyerddddddddd);
...
// navigation menu items declaration
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuitem) {
        ...
        switch (menuitem.getItemId()) {
            case R.id.nav_buyerhome:
                Intent intent = new Intent(Buyerddddddddd.this, BuyerDashboard.class);
                startActivity(intent);
                break;
            case R.id.nav_buyerprofile:
                Intent intent1 = new Intent(Buyerddddddddd.this, BuyerProfile.class);
                startActivity(intent1);
                break;
            case R.id.nav_buyerinfo:
                Intent intent3 = new Intent(Buyerddddddddd.this, BuyerAboutUs.class);
                startActivity(intent3);
                break;
            case R.id.nav_buyerSecurity:
                Intent security = new Intent(Buyerddddddddd.this, Buyer_Security.class);
    ...
    public void openbuyerprofile() {
        Intent intent = new Intent(Buyerddddddddd.this, BuyerProfile.class);
        startActivity(intent);
    }
}