...
public class SellerRedeem extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    public DrawerLayout drawerLayout;
    public NavigationView navigationView;
    public TextView navHeadername, name1;
    ...
    Seller_ViewBuyerRewardsAdapter myAdapter;
    ArrayList<Seller_ViewBuyerRewards > list;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_seller_redeem);
        ...
        recyclerView = findViewById(R.id.sellerviewbuyer);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        list = new ArrayList<Seller_ViewBuyerRewards>();
        myAdapter = new Seller_ViewBuyerRewardsAdapter(this, list);
...
//display profile picture
    ...
    private void EventChangeListner() {
        String buyerid = "MC4BvZ9tWtYna1hBlXJk9moAqce2";
        DocumentReference ref = fStore.collection("Buyer_Users").document(buyerid);
        ref.collection("products").addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                for (DocumentChange dc : value.getDocumentChanges()) {
                    if (dc.getType() == DocumentChange.Type.ADDED) {
                        list.add(dc.getDocument().toObject(Seller_ViewBuyerRewards.class));
...
// navigation menu items declaration
        ...
        navigationView.setCheckedItem(R.id.nav_sellerredeem);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuitem) {
        ...
        switch (menuitem.getItemId()) {
            case R.id.nav_sellerhome:
                Intent intent = new Intent(SellerRedeem.this, SellerDashboard.class);
                startActivity(intent);
                break;
            case R.id.nav_sellerprofile:
                Intent intent1 = new Intent(SellerRedeem.this, SellerProfile.class);
                startActivity(intent1);
                break;
            case R.id.nav_sellerlocation:
                Intent intent2 = new Intent(SellerRedeem.this, SellerLocation.class);
                startActivity(intent2);
                break;
            case R.id.nav_sellerSecurity:
                Intent security = new Intent(SellerRedeem.this, Seller_Security.class);
                startActivity(security);
                break;
            case R.id.nav_sellerinfo:
                Intent intent3 = new Intent(SellerRedeem.this, SellerAboutUs.class);
    ...
    public void opensellerprofile() {
        Intent intent = new Intent(SellerRedeem.this, SellerProfile.class);
        startActivity(intent);
    }
}