...
public class SellerChooseAShopOne extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seller_choose_ashop_one);

        btn_back = findViewById(R.id.btn_back);
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent back = new Intent(SellerChooseAShopOne.this, SellerChooseAShop.class);
                startActivity(back);
            }
        });
...
//Display user info in drawer
        ...
        documentReference.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                String shopid1 = intent.getStringExtra("BUYERONE");
                final TextView UsernameShop = findViewById(R.id.shopname);

                DocumentReference documentReference2 = fStore.collection("Buyer_Users").document(shopid1);
                documentReference2.addSnapshotListener(new EventListener<DocumentSnapshot>() {
                    ...
                    public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                        ...
                        DocumentReference documentReference3 = fStore.collection("Buyer_Users").document("CuNdf5X5RRObsP5o0IgyFNkEyUj2");
...
// navigation menu items declaration
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuitem) {
        ...
        switch (menuitem.getItemId()) {
            case R.id.nav_sellerhome:
                Intent intent = new Intent(SellerChooseAShopOne.this, SellerDashboard.class);
                startActivity(intent);
                break;
            case R.id.nav_sellerprofile:
                Intent intent1 = new Intent(SellerChooseAShopOne.this, SellerProfile.class);
                startActivity(intent1);
                break;
            case R.id.nav_sellerredeem:
                Intent redeem = new Intent(SellerChooseAShopOne.this, SellerRedeem.class);
                startActivity(redeem);
                break;
            case R.id.nav_sellerlocation:
                Intent intent2 = new Intent(SellerChooseAShopOne.this, SellerLocation.class);
                startActivity(intent2);
                break;
            case R.id.nav_sellerSecurity:
                Intent security = new Intent(SellerChooseAShopOne.this, Seller_Security.class);
                startActivity(security);
                break;
            case R.id.nav_sellerinfo:
                Intent intent3 = new Intent(SellerChooseAShopOne.this, SellerAboutUs.class);
    ...
    public void opensellerprofile() {
        Intent intent = new Intent(SellerChooseAShopOne.this, SellerProfile.class);
        startActivity(intent);
    }
}