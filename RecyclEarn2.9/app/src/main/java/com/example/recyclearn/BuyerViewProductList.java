...
public class BuyerViewProductList extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    BuyerRewardsAdapter myAdapter;
    ArrayList<Buyer_Rewards> list;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_buyer_view_product_list);

        user = FirebaseAuth.getInstance().getCurrentUser();
        fStore = FirebaseFirestore.getInstance();
        userID = user.getUid();

        recyclerView = findViewById(R.id.buyerproductlist);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        list = new ArrayList<Buyer_Rewards>();
        myAdapter = new BuyerRewardsAdapter(BuyerViewProductList.this,list);
...
//display profile picture
    ...
    private void EventChangeListner() {
        DocumentReference ref = fStore.collection("Buyer_Users").document(userID);
            ...
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                for (DocumentChange dc : value.getDocumentChanges()){
                    if(dc.getType() == DocumentChange.Type.ADDED){
                        list.add(dc.getDocument().toObject(Buyer_Rewards.class));
                    }
...
// navigation menu items declaration
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuitem) {
        ...
        switch (menuitem.getItemId()) {
            case R.id.nav_buyerhome:
                Intent intent = new Intent(BuyerViewProductList.this, BuyerDashboard.class);
                startActivity(intent);
                break;
            case  R.id.nav_buyerprofile:
                Intent intent1 = new Intent(BuyerViewProductList.this, BuyerProfile.class);
                startActivity(intent1);
                break;
            case R.id.nav_buyerinfo:
                Intent intent3 = new Intent(BuyerViewProductList.this, BuyerAboutUs.class);
                startActivity(intent3);
                break;
            case R.id.nav_buyerSecurity:
                Intent security = new Intent(BuyerViewProductList.this, Buyer_Security.class);
    ...
    public void openbuyerprofile(){
        Intent intent = new Intent(BuyerViewProductList.this, BuyerProfile.class);
        startActivity(intent);
    }
}