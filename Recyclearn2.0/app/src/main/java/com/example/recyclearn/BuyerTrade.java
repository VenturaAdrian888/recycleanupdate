    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuitem) {
        ...
        switch (menuitem.getItemId()) {
            ...
            case R.id.nav_buyerlocation:
                Intent intent2 = new Intent(BuyerTrade.this, BuyerLocation.class);
                startActivity(intent2);
                break;
            case R.id.nav_buyerinfo:
                Intent intent3 = new Intent(BuyerTrade.this, SellerFaqs.class);
                startActivity(intent3);
                break;
            case R.id.nav_buyerlogout:
                Intent intent4 = new Intent(BuyerTrade.this, MainActivity.class);
