...
//Display user info in drawer
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(BuyerTradeQr.this, "Something wrong happened!", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuitem) {
        ...
        switch (menuitem.getItemId()) {
            ...
            case R.id.nav_buyerlocation:
                Intent intent2 = new Intent(BuyerTradeQr.this, BuyerLocation.class);
                startActivity(intent2);
                break;
            case R.id.nav_buyerinfo:
                Intent intent3 = new Intent(BuyerTradeQr.this, SellerFaqs.class);
                startActivity(intent3);
                break;
            case R.id.nav_buyerlogout:
                Intent intent4 = new Intent(BuyerTradeQr.this, MainActivity.class);
