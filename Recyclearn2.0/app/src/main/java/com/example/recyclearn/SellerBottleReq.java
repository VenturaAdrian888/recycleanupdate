...
//Display user info in drawer
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(SellerBottleReq.this, "Something wrong happened!", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuitem) {
        ...
        switch (menuitem.getItemId()) {
            ...
            case R.id.nav_sellerinfo:
                Intent intent3 = new Intent(SellerBottleReq.this, SellerFaqs.class);
                startActivity(intent3);
                break;
            case R.id.nav_sellerlogout:
                Intent intent4 = new Intent(SellerBottleReq.this, MainActivity.class);
