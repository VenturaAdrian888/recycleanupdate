...
public class BuyerLocation extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buyer_location);
        //drawer
...
//Display user info in drawer
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(BuyerLocation.this, "Something wrong happened!", Toast.LENGTH_SHORT).show();
            }
        });
// display profile picture in navigation drawer
        nav_buyerprofile = navigationView.getHeaderView(0).findViewById(R.id.nav_buyerprofile2);
...
// navigation menu items declaration
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuitem) {
        ...
        switch (menuitem.getItemId()) {
            case R.id.nav_buyerhome:
                Intent intent = new Intent(BuyerLocation.this, BuyerDashboard.class);
                startActivity(intent);
                break;
            case  R.id.nav_buyerprofile:
                Intent intent1 = new Intent(BuyerLocation.this, BuyerProfile.class);
                startActivity(intent1);
                break;
            case R.id.nav_buyerlocation:
                break;
            case R.id.nav_buyerinfo:
                Intent intent2 = new Intent(BuyerLocation.this, SellerFaqs.class);
                startActivity(intent2);
                break;
            case R.id.nav_buyerlogout:
                Intent intent3 = new Intent(BuyerLocation.this, MainActivity.class);
    ...
    public void openbuyerprofile(){
        Intent intent = new Intent(BuyerLocation.this, BuyerProfile.class);
        startActivity(intent);
    }
}