...
//Display user info in drawer
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(SellerTradeGenQR.this, "Something wrong happened!", Toast.LENGTH_SHORT).show();
            }
        });
...
//QR input
        ...
        kgInput1.setTransformationMethod(null);
    ...
    public boolean goToGen() {
        double userinput = Double.parseDouble(kgInput1.getText().toString().trim());
        String input = kgInput1.getText().toString().trim();
        if (input.isEmpty()) {
        ...
        if (userinput > 5) {
            kgInput1.setError("Maximum of 5 KG");
            kgInput1.requestFocus();
            return false;
        }
        if (userinput < 0.5) {
...
// navigation menu items declaration
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuitem) {
        ...
        switch (menuitem.getItemId()) {
            ...
            case R.id.nav_sellerinfo:
                Intent intent3 = new Intent(SellerTradeGenQR.this, SellerFaqs.class);
                startActivity(intent3);
                break;
            case R.id.nav_sellerlogout:
                Intent intent4 = new Intent(SellerTradeGenQR.this, MainActivity.class);
    ...
    public void genQR() {
        ...
        //   Intent goqr = new Intent(SellerTradeGenQR.this, SellertradeGenerate.class);
