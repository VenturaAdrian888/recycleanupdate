...
public class SellerAboutUs extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seller_about_us);
...
//Display user info in drawer
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(SellerAboutUs.this, "Something wrong happened!", Toast.LENGTH_SHORT).show();
            }
        });
...
// navigation menu items declaration
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuitem) {
        ...
        switch (menuitem.getItemId()) {
            case R.id.nav_sellerhome:
                Intent intent = new Intent(SellerAboutUs.this, SellerDashboard.class);
                startActivity(intent);
                break;
            case  R.id.nav_sellerprofile:
                Intent intent1 = new Intent(SellerAboutUs.this, SellerProfile.class);
                startActivity(intent1);
                break;
            case R.id.nav_sellerlocation:
                Intent intent2 = new Intent(SellerAboutUs.this, SellerLocation.class);
                startActivity(intent2);
                break;
            case R.id.nav_sellerinfo:
                Intent intent3 = new Intent(SellerAboutUs.this, SellerAboutUs.class);
    ...
    public void opensellerprofile(){
        Intent intent = new Intent(SellerAboutUs.this, SellerProfile.class);
        startActivity(intent);
    }
}