...
public class BuyerTradeQr extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public  Button scanqr, decline, accept;
...
//display profile picture
        ...
        decline.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent send = new Intent(BuyerTradeQr.this, BuyerTradeQr.class);
                startActivity(send);
            }
        });
        ...
        accept.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent send1 = new Intent(BuyerTradeQr.this, BuyerTradeSuccess.class);
                startActivity(send1);
