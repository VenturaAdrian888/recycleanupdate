...
public class BuyerTrade extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private TextView buyer_bottles;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_buyer_trade);
        //drawer
...
//Display user info in drawer
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(BuyerTrade.this, "Something wrong happened!", Toast.LENGTH_SHORT).show();
            }
        });
...
//display profile picture
        ...
        continuescan = findViewById(R.id.continuescan);
        ...
        buyer_bottles = findViewById(R.id.buyer_bottles);
        buyer_bottles.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                buyerreqbot();
            }
...
// navigation menu items declaration
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuitem) {
        ...
        switch (menuitem.getItemId()) {
            case R.id.nav_buyerhome:
                Intent intent = new Intent(BuyerTrade.this, BuyerDashboard.class);
                startActivity(intent);
                break;
            case  R.id.nav_buyerprofile:
                Intent intent1 = new Intent(BuyerTrade.this, BuyerProfile.class);
                startActivity(intent1);
                break;
            case R.id.nav_buyerinfo:
                Intent intent3 = new Intent(BuyerTrade.this, BuyerAboutUs.class);
    ...
    public void openbuyerprofile(){
        Intent intent = new Intent(BuyerTrade.this, BuyerProfile.class);
        startActivity(intent);
    }
    public void continueButton(){
        Intent toqr = new Intent(BuyerTrade.this, BuyerTradeQr.class);
        startActivity(toqr);
    }
    public void buyerreqbot(){
        Intent example = new Intent(BuyerTrade.this, BuyerBottleReq.class);
